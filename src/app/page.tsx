                      ...
                      <div key={a.id} className="pc" style={{ display: 'flex', flexDirection: 'column' }}>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 8 }}>
                          <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
                            {a.promotion && a.promotion > 0 ? (
                              <>
                                <span style={{ textDecoration: 'line-through', color: '#999', fontSize: '0.9em' }}>{a.prix.toFixed(2)}€</span>
                                <span style={{ color: '#B71C1C', fontWeight: 'bold' }}>{(a.prix * (1 - a.promotion / 100)).toFixed(2)}€</span>
                                <span style={{ background: '#B71C1C', color: 'white', padding: '2px 6px', borderRadius: 4, fontSize: '0.75em', marginLeft: 4 }}>-{a.promotion}%</span>
                              </>
                            ) : (
                              <>
                          ...
                          <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                            ...
                            {!a.promotion && a.prix_reduction && <span className="bdg bdg-promo">Promo</span>}
                          </div>
                        </div>
                      </div>
                    ))}
                        ...
                        <div style={{ textAlign: 'right', flexShrink: 0 }}>
                          {a.promotion && a.promotion > 0 ? (
                            <div>
                              ...
                              {' '}
                              <span style={{ color: '#B71C1C', fontWeight: 'bold' }}>{(a.prix * (1 - a.promotion / 100)).toFixed(2)}€</span>
                              <div><span style={{ background: '#B71C1C', color: 'white', padding: '2px 6px', borderRadius: 4, fontSize: '0.75em' }}>-{a.promotion}%</span></div>
                            </div>
                          ) : a.prix_reduction ? (
                            <div>
